...
png(file="plot4.png",width=480,height=480,units="px") #open the png device
#Graph 4
par(mfcol=c(2,2))
#1,1
par(mar=c(4,4,2,2))
...
#1,2
par(mar=c(4,4,2,2))
with(data2,plot(DateAndTime,Voltage,type="l" ,xlab="datetime",ylab="Voltage"))

#2,2
par(mar=c(4,4,2,2))
with(data2,plot(DateAndTime,Global_reactive_power,type="l" ,xlab="datetime",ylab="Global_reactive_power"))
